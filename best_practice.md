...
* Debugger
  * On the left toolbar of VS Code, there is a flask-like icon which on hovering over with a mouse reads 'Testing'.
  ...
  * All tests in the project should show up in the space next to the toolbar. Clicking the 'Play' icon should run all tests. Individual tests can also be run separately if needed.
